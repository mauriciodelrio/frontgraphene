  ...
  return (
    <div className="flex flex-col items-center sm:w-full justify-center min-h-screen py-2">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 sm:px-2 md:px-10 text-center">
        <div class="max-w-screen-lg bg-white rounded-lg mx-auto text-center py-12 mt-4 w-full mb-20">
          ...
          <div class="mt-8 flex justify-center align-center items-center">
            <img src="carbon2.svg" alt="carbon2" class="w-48 h-48 flex justify-center mx-auto" />
          </div>
          <div class="grid grid-cols-2 gap-4 pt-8">
            ...
            <div class="mx-4 flex justify-center rounded-md bg-pink-500 shadow content-center">
              <a href="/api/auth/login" class="text-gray-200 font-bold py-2 px-6 justify-center content-center">
                Ve nuestros planes
              </a>
            </div>
            <div class="mx-4 flex justify-center rounded-md bg-pink-500 shadow content-center">
